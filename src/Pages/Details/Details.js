    ...
    return (
        <div>
            <h2 className="text-4xl">services : {title}</h2>
                ...
                {!showDet && <button onClick={setShowDet} className=' btn btn-outline'>Details</button>}
             <form className='flex justify-center mt-10' onSubmit={handlePlaceReview}>
                        ...
                        <div className='grid grid-cols-1 gap-4 w-1/2'>
                            ...
                            <input onClick={()=>sets(true)} className=' btn btn-outline my-5 px-5 w-20' type="submit" value="submit" />
                            <Toaster
                            position="top-center"
                            reverseOrder={false}
                            />
